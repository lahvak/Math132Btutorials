...
```{r small_baby-check}
res <- pnorm(3.34, mean = 3.296, sd = 0.56)
grade_result(
  fail_if(~ (.result < res), "Sorry, this number is too small. Try again."),
  fail_if(~ (.result > res), "Sorry, this number is too large. Try again."),
  pass_if(~ (.result == res), "Good job!")
)
```
